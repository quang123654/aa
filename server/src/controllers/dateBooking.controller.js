...
exports.createNewDateBooking = (req, res) => {
    ...
    if (req.body.contructor === Object && Object.keys(req.body).length === 0) {
        ...
        dateBookingModel.createBookingTable(dateBoookingReqData, (err, realEstate) => {
            if (err)
                res.send(err);
            res.json({ status: true, message: 'DateBooking Created Successfully', data: realEstate.insertId })
