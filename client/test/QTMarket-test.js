...
describe("QTMarket", function () {
  it("Should mint and trade NFTs", async function () {
    ...
    await market.connect(buyerAddress).addDatesBooked(nftContractAddress, 1, ["29/02/2022"] ,{
      value: auctionPrice,
    });

    await market.connect(buyerAddress).addDatesBooked(nftContractAddress, 1, ["27/02/2022"] ,{
      value: auctionPrice,
    });
